...
.pull-left[
```{r out.width='100%', fig.height=4, eval=require('leaflet'), echo=FALSE}
...
```
.caption[
Map of jetty to Aquarium route 
]
]
...
.caption[
Microscope recording of bacterial multiplication
]
]
.pull-right[
...
- Digest prey on .blue[outside] of body
]
]
