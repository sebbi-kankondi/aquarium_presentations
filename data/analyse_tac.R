...
tac_data <- read.csv("C:/Users/Sebbi Kankondi/Documents/National Marine Aquarium/Presentations/data/historic_catch.csv",
                     skip=2) %>% 
  clean_names() %>% 
...
tac_data <- rbind(tac_data, add_data) %>% 
  mutate(log_catch = log(catch), #generate log transformed catch values
         log_catch = replace(log_catch, is.infinite(log_catch), 0)) #replace any -inf values
...
ggsave(filename = "C:/Users/Sebbi Kankondi/Documents/National Marine Aquarium/Presentations/images/mfmr_landings.png",
...
# #save as html file
saveWidget(mfmr_landings, "C:/Users/Sebbi Kankondi/Documents/National Marine Aquarium/Presentations/images/mfmr_landings.html")
